...
```
And all metods is from stock api function, as in PurePerms. Watch all metods in main class or in https://github.com/XackiGiFF/MPEPerms/blob/pm5-dev/src/XackiGiFF/MPEPerms/api/MPEPermsAPI.php (/src/XackiGiFF/MPEPerms/api/MPEPermsAPI.php)
